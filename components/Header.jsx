      ...
      >
        ...
        <div className=" flex items-center gap-2 text-black">
          ...
          {/* <div className=" flex items-center gap-2 text-black"> */}
            ...
            <div className=" h-[14px] md:h-[18px] min-w-[14px] md:min-w-[18px] rounded-full flex  md:hidden justify-center items-center hover:bg-black/[0.05] cursor-pointer relative -mr-2 ">
              {mobileMenu ? (
                <VscChromeClose
                  className=" text-[16px]"
